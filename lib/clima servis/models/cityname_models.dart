...
//
//     final cityNameResponsive = cityNameResponsiveFromMap(jsonString);

import 'dart:convert';

class CityNameResponsive {
    CityNameResponsive({
       required this.coord,
    ...
    factory CityNameResponsive.fromJson(String str) => CityNameResponsive.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory CityNameResponsive.fromMap(Map<String, dynamic> json) => CityNameResponsive(
